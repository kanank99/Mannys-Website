      ...
      <div className="max-w-[1200px] mx-auto pb-[40px] pt-[60px]">
        <div className="flex justify-between items-center mx-[30px]">
          <div className="max-w-[400px]">
            ...
            <a
              class="mt-[40px] inline-flex justify-center items-center gap-x-3 text-center w-[200px] bg-gradient-to-tl from-[#004F71] to-[#138AB5] hover:from-[#138AB5] hover:to-[#004F71] text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300"
              href="#"
            >
              Take Out
              <svg
